...
var CronQueue = /** @class */ (function (_super) {
    ...
    CronQueue.prototype.schedule = function (namespace, scheduleString, options) {
        ...
        var task = cron.schedule(scheduleString, function () {
            _this.enqueue(namespace, { taskID: task.options.name, namespace: namespace, data: data });
    ...
    CronQueue.prototype.getTask = function (namespace) {
        var _a;
        return (_a = this.getTasks()) === null || _a === void 0 ? void 0 : _a.get(namespace);
    };
    return CronQueue;
}(Queue));
